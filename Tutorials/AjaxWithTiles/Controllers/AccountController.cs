...
namespace AjaxWithTiles.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public class MemberShipPrincipal : IPrincipal
        {
            private String _user;

            public MemberShipPrincipal(String user)
            {
                _user = user;
            }
            ...
            {
                get { return new MemberShipIdentity(_user); }
            }

            public class MemberShipIdentity : IIdentity
            {
                private String _user;

                public MemberShipIdentity(String user)
                {
                    _user = user;
                }
        ...
        public ActionResult ChangePassword(string currentPassword, string newPassword, string confirmPassword)
        {
            ...
            try
            {
                ...
                {
                    return this.Update("ChangePasswordSuccess").Render();
                }
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public MembershipUser GetCurrentUser(string userName)
        {
