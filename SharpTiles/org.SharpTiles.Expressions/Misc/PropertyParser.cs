...
{
    public class PropertyParser : IExpressionParser
    {
        #region IExpressionParser Members

        public Type[] ParsedTypes
        {
            get { return new[] {typeof (Property)}; }
        }

        public ExpressionOperatorSign DistinctToken
        {
            get { throw new NotImplementedException("Property hasn't got a distinct token"); }
        }
        ...
        {
            var property = new Property(parseHelper.CurrentTrimmed.Contents);
