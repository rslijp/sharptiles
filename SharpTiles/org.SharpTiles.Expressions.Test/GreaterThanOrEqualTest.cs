...
namespace org.SharpTiles.Expressions.Test
{
    ...
    public class GreaterThanOrEqualTest
    {
        ...
        {
            var lt = new GreaterThanOrEqual(new Constant("23"), new Constant("12"));
            Assert.IsTrue((bool) lt.Evaluate(new Reflection(this)));
            lt = new GreaterThanOrEqual(new Constant("12"), new Constant("23"));
            Assert.IsFalse((bool) lt.Evaluate(new Reflection(this)));
            lt = new GreaterThanOrEqual(new Constant("12"), new Constant("12"));
            Assert.IsTrue((bool) lt.Evaluate(new Reflection(this)));
        }
    }
}
